...
export default class ClassEnrollmentCard extends Component {
    constructor(props) {
        super(props);
        this.state = {
            enrollments: []
    ...
    getEnrollments(courseId) {
        if (courseId) {
            EnrollmentService.findByCourse(courseId).then((enrollments) =>
        ...
        switch (index) {
            ...
            case 1:
                EnrollmentService.deleteItem(data.id).then(() =>
                    this.getEnrollments(this.props.course.id)
                );
                break;
            default:
                break;
            ...
            <div className="slds-card">
                <header className="slds-card__header slds-grid">
                    ...
                    <div className="slds-no-flex">
                        <StudentSearchBox
                            placeholder="Search to enroll..."
                            onSelect={this.studentSelectHandler}
                        />
                    </div>
                </header>
                ...
                <section className="slds-card__body">
                    ...
                    >
                        <div
                            ...
                            field="first_name"
                            sortable
                            onLink={this.studentLinkHandler}
                        />
                        <div
                            header="Last Name"
                            field="last_name"
